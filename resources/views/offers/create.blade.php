    ...
    <div class="row justify-content-center mt-3">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('offer.store', ['productId'=>$product->id])}}" method="post">
                        @csrf
                        ...
                        <!-- Price Field -->
                        <div class="mb-3 row">
                            <label for="price" class="col-md-4 col-form-label text-md-end text-start">Price per piece</label>
                            <div class="col-md-6">
                        ...
                        <!-- Total price Field -->
                        <div class="mb-3 row">
                            <label for="price" class="col-md-4 col-form-label text-md-end text-start">Total price({{ $product->price * $product->quantity }}) </label>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3 row">
                            <input type="submit" class="col-md-3 offset-md-5 btn btn-info" value="Offer">
                        </div>
